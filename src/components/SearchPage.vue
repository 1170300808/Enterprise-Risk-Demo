<template>
  <div>
    ...
    <el-header class="header">
      ...
      <!-- 搜索框 -->
      <el-input v-model="searchQuery" placeholder="搜索企业名" class="header-search" @keyup.enter="handleSearch">
        <template #append>
    ...
    <el-main>
      ...
      <div class="search-page">
        <!-- 搜索框 -->
        <el-input v-model="searchQuery" placeholder="搜索企业名" class="search-input" @keyup.enter="handleSearch">
          <template #append>
            <!-- 使用图标组件 -->
